...
import CustomModal from '@/pages/componentes/modals/modalsUeducativa';
      ...
      <Card>
        ...
        <CardBody className="flex flex-col gap-4 p-4 overflow-x-scroll"> {/* Quité overflow-x-auto */}
          ...
          <CustomModal
              isOpen={isModalOpen}
              onClose={closeModal}
              title="REGISTRO DE NUEVO U. EDUCATIVA"
              bodyContent={[
