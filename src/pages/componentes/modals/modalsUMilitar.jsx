...
const CustomModal = ({ isOpen, onClose, title, bodyContent, onAction, actionLabel, closeLabel }) => {
  ...
  const {handleSubmit,handleBlur,values,handleChange,errors,touched,resetForm }= useFormik({
    ...
    validationSchema:Yup.object({
      ...
      .matches(/^[0-9]{1,15}$/, 'El codigo debe tener entre 5 y 15 dígitos')
      .required('El codigo es requerido'),
      nombre:Yup.string().max(100,'Debe tenere maximo 100 caracteres').min(3,'Debe tener como minimo 3 caracteres').required('El nombre de U.M. es requerido'),
          ...
          <>
            ...
            <form noValidate onSubmit={handleSubmit}>
              ...
              <div className="flex w-full flex-wrap md:flex-nowrap gap-6">
                ...
                onBlur={handleBlur}
                color={errors.identificador ? "danger" : "success"}
              ...
              <Input 
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                isInvalid={!!errors.prioridad && touched.prioridad}
                color={errors.prioridad ? "danger" : "success"}
